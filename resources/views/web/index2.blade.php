...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-6">
                    <nav>
                        <ul>
                            <a style="color: white;" href="{{ route('landing.en') }}">English</a> | <a href="{{ route('landing.id') }}">Bahasa Indonesia</a>
    ...
    <main>
        <div class="hero home-search full-height jarallax" data-background="{{ asset('landing/img/villa-awal.jpeg') }}" data-speed="0.2">
            ...
            <div class="pinned-image pinned-image--medium">
                <div class="pinned-image__container" id="section_video">
                    <video loop="loop" muted="muted" id="video_home">
                        <source src="{{ asset('landing/video/swimming_pool_2.mp4') }}" type="video/mp4">
                        <source src="{{ asset('landing/video/swimming_pool_2.webm') }}" type="video/webm">
                        <source src="{{ asset('landing/video/swimming_pool_2.ogv') }}" type="video/ogg">
                    </video>
        ...
        <div class="container margin_120_95">
            ...
            <div class="row justify-content-center add_bottom_90" data-cues="slideInUp" data-delay="300">
                <?php foreach ($images as $index => $image) : ?>
                    <div class="col-xl-<?php echo ($index === 0) ? '6' : '3'; ?> col-lg-<?php echo ($index === 0) ? '12' : '6'; ?> col-md-<?php echo ($index === 0) ? '12' : '6'; ?> col-sm-<?php echo ($index === 0) ? '12' : '6'; ?>">
        ...
        <div class="container">
            <div class="row move_content">
                <div class="col-lg-4 col-md-12">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3944.540301801533!2d115.13979947559187!3d-8.640051791406577!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd23889f70c0367%3A0x766be1e2f663b367!2sKubu%20Manyar%20Homestay!5e0!3m2!1sid!2sid!4v1701130666930!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
    ...
    <script src="{{ asset('lansing/js/datepicker_search.js') }}"></script>
    <script src="{{ asset('lansing/js/datepicker_inline.js') }}"></script>
    <script src="{{ asset('lansing/phpmailer/validate.js') }}"></script>
